...
/* Inputs and outputs are array_view double containers */
...
hcblasStatus gemm_NoTransA_rMajor_d(hc::accelerator_view &accl_view,
                                  ...
                                  double alpha, double beta) {
  if(M < 1000 && N < 1000 && K > 10000) {
    return gemm_NoTransA_rMajor_largeK_d(accl_view, A, aOffset, B, bOffset, C, cOffset, M, N, K, lda, ldb, ldc, alpha, beta);
  } else if((M < 6000 && N < 600 && K < 10) || (M > 1800 && M < 6000 && K > 1800 &&  K < 10000 && N < 10)) {
...
hcblasStatus gemm_NoTransB_rMajor_d(hc::accelerator_view &accl_view,
                                  ...
                                  double alpha, double beta) {
  if(M < 1000 && N < 1000 && K > 10000) {
    return gemm_NoTransB_rMajor_largeK_d(accl_view, A, aOffset, B, bOffset, C, cOffset, M, N, K, lda, ldb, ldc, alpha, beta);
  } else if( M > 1800 && M < 6000 && N > 600 && N < 1800 && K < 600 ) {
    return gemm_NoTransB_rMajor_MICRO_NBK_TS16XMTS2_d(accl_view, A, aOffset, B, bOffset, C, cOffset, M, N, K, lda, ldb, ldc, alpha, beta);
  } else if (M > 600 && M < 1800 && N < 600 && K < 10) {
    return gemm_NoTransB_rMajor_STEP_TS8XSS8_d(accl_view, A, aOffset, B, bOffset, C, cOffset, M, N, K, lda, ldb, ldc, alpha, beta);
  } else if (M > 1800 && M < 6000 && N > 1800 && N < 6000 && K < 10) {
...
hcblasStatus gemm_TransAB_rMajor_d(hc::accelerator_view &accl_view,
                                 ...
                                 double alpha, double beta) {
  if(M < 1000 && N < 1000 && K > 10000) {
    return gemm_TransAB_rMajor_largeK_d(accl_view, A, aOffset, B, bOffset, C, cOffset, M, N, K, lda, ldb, ldc, alpha, beta);
  } else if ( M > 600 && M < 1800 && N < 200 && K > 600 && K < 1800) {
    ...
    return gemm_TransAB_rMajor_MICRO_NBK_TS16XMTS2_d(accl_view, A, aOffset, B, bOffset, C, cOffset, M, N, K, lda, ldb, ldc, alpha, beta);
  } else if(M > 6000 && M < 10000 && N < 600 && K < 10) {
