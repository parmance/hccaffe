                               ...
                               double alpha, double beta, int batchSize)
{
    if (M < 600 && N < 600 && K < 10)
    {
        return gemm_NoTransAB_STEP_NBK_TS8XSS8_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if ((M < 600 && ((N < 600 && K < 1800) || (N < 1800 && K < 10) || (N < 6000 && (K < 10 || (K >= 600 && K < 1800))))) || (M < 2000 && ((N < 600 && K < 1800) || (N < 1800 && K < 10))) || (M < 6000 && N < 1800 && K < 10) || (M < 10000 && N < 600 && M == K))
    {
        return gemm_NoTransAB_STEP_NBK_TS16XSS16_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if (M < 1800 && N < 1800 && K < 1800)
    {
        return gemm_NoTransAB_MICRO_TS16XMTS2_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if (M < 10000 && N < 600 && K < 10)
    {
        return gemm_NoTransAB_STEP_TS8XSS8_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else {
        return gemm_NoTransAB_STEP_NBK_TS16XSS16_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
                              ...
                              double alpha, double beta, int batchSize)
{
    if ((M < 10 && N < 1800 && K < 600) || (M < 600 && ((N < 600 && K < 1800) || (N < 6000 && K < 10))) || (M < 6000 && N < 600 && K < 10))
    {
        return gemm_NoTransA_STEP_NBK_TS16XSS16_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if ((M < 600 && N < 1800 && K < 1800) || (M < 1800 && N < 1800 && K < 600))
    {
        return gemm_NoTransA_MICRO_NBK_TS16XMTS2_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if ((M < 10 && N < 1800 && K < 1800) || (M < 600 && (N < 10 || (N >= 1800 && N < 6000)) && K < 1800) || (M < 1800 && ((N < 10 && K < 1800) || (N < 600 && K >= 10 && K < 600))) || (M < 10000 && N < 600 && M == K))
    {
        return gemm_NoTransA_STEP_TS16XSS16_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if (M < 1800 && N < 1800 && K < 1800)
    {
        return gemm_NoTransA_MICRO_TS16XMTS2_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if ((M < 6000 && N < 1800 && K < 10) || (M < 10000 && N < 600 && K < 10))
    {
        return gemm_NoTransA_STEP_NBK_TS8XSS8_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else {
        return gemm_NoTransA_MICRO_TS16XMTS2_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
                              ...
                              double alpha, double beta, int batchSize)
{
    if (((M >= 10 && M < 600) && N < 600 && K < 10) || (M >= 6000 && M < 10000 && N < 600 && K < 10))
    {
        return gemm_NoTransB_STEP_TS8XSS8_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if ((M > 10 && M < 600) && N < 10 && K < 10)
    {
        return gemm_NoTransB_STEP_NBK_TS8XSS8_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if ((((M < 10 && N < 1800) || (M >= 600 && M < 1800 && N < 10) || (M < 600 && N < 1800)) && K < 1800) || (M >= 1800 && M < 6000 && N < 1800 && K < 10) || (M < 600 && N >= 1800 && N < 6000 && K < 10) || (M < 1800 && N < 600 && K <600) || (M >= 6000 && M < 10000 && N < 600 && (K < 10 || M == K)) || (M < 600 && N >= 1800 && N < 6000 && K < 1800))
    {
        return gemm_NoTransB_STEP_NBK_TS16XSS16_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else if (M < 1800 && N < 1800 && K < 600)
    {
        return  gemm_NoTransB_MICRO_NBK_TS16XMTS2_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else
    {
        return  gemm_NoTransB_MICRO_TS16XMTS2_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
                             ...
                             double alpha, double beta, int batchSize)
{
    if ((M < 600 && N < 600 && K < 10) || (M < 1800 && N < 600 && K < 600))
    {
        return gemm_TransAB_STEP_NBK_TS8XSS8_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    if ((M < 600 && N < 600 && K < 1800) || (M < 1800 && ((N < 600 && K < 1800) || (N < 1800 && K < 10))))
    {
        return gemm_TransAB_STEP_NBK_TS16XSS16_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
    else
    {
        return gemm_TransAB_MICRO_TS16XMTS2_d(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
    }
