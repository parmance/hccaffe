...
#if MKTYPE
static void gemm_NoTransB_MK(Concurrency::array_view<double, 1> &A, long aOffset,
                                ...
                                double alpha, double beta)
{
  ...
  {
    double4 a01, a11, a21, a31, a02, a12, a22, a32;
    double4 b01, b11, b21, b31, b02, b12, b22, b32;
    double4 c0, c1, c2, c3;
    ...
    tile_static double4 scratch[8 * 8 * 4];
    ...
    for( uint mstep = 0; mstep < 8; mstep += 8 ) {
		...
		cIndex = (coordX * ldc + coordY)/4;
                ...
                double4 tempC0, tempC1, tempC2, tempC3;
...
#endif
#if RECTANGULAR_TILING
static void gemm_NoTransA_rect(Concurrency::array_view<double, 1> &A, long aOffset,
                               Concurrency::array_view<double, 1> &B, long bOffset,
                               Concurrency::array_view<double, 1> &C, long cOffset,
                               int M, int N, int K, int lda, int ldb, int ldc,
                               double alpha, double beta)
...
static void gemm_NoTransA_extend(Concurrency::array_view<double, 1> &A, long aOffset,
                                Concurrency::array_view<double, 1> &B, long bOffset,
                                Concurrency::array_view<double, 1> &C, long cOffset,
                                int M, int N, int K, int lda, int ldb, int ldc,
                                double alpha, double beta)
...
static void gemm_NoTransB_extend(Concurrency::array_view<double, 1> &A, long aOffset,
                                Concurrency::array_view<double, 1> &B, long bOffset,
                                Concurrency::array_view<double, 1> &C, long cOffset,
                                int M, int N, int K, int lda, int ldb, int ldc,
                                double alpha, double beta)
...
static void gemm_NoTransAB_extend(Concurrency::array_view<double, 1> &A, long aOffset,
                                Concurrency::array_view<double, 1> &B, long bOffset,
                                Concurrency::array_view<double, 1> &C, long cOffset,
                                int M, int N, int K, int lda, int ldb, int ldc,
                                double alpha, double beta)
...
static void gemm_TransAB_extend(Concurrency::array_view<double, 1> &A, long aOffset,
                                Concurrency::array_view<double, 1> &B, long bOffset,
                                Concurrency::array_view<double, 1> &C, long cOffset,
                                int M, int N, int K, int lda, int ldb, int ldc,
                                double alpha, double beta)
...
static void gemm_NoTransAB_loopunroll_swprefetch(Concurrency::array_view<double, 1> &A, long aOffset,
                                                 Concurrency::array_view<double, 1> &B, long bOffset,
                                                 Concurrency::array_view<double, 1> &C, long cOffset,
                                                 int M, int N, int K, int lda, int ldb, int ldc,
                                                 double alpha, double beta)
...
static void gemm_NoTransA_loopunroll_swprefetch(Concurrency::array_view<double, 1> &A, long aOffset,
                                                Concurrency::array_view<double, 1> &B, long bOffset,
                                                Concurrency::array_view<double, 1> &C, long cOffset,
                                                int M, int N, int K, int lda, int ldb, int ldc,
                                                double alpha, double beta)
...
static void gemm_NoTransB_loopunroll_swprefetch(Concurrency::array_view<double, 1> &A, long aOffset,
                                                Concurrency::array_view<double, 1> &B, long bOffset,
                                                Concurrency::array_view<double, 1> &C, long cOffset,
                                                int M, int N, int K, int lda, int ldb, int ldc,
                                                double alpha, double beta,
...
static void gemm_TransAB_loopunroll_swprefetch(Concurrency::array_view<double, 1> &A, long aOffset,
                                               Concurrency::array_view<double, 1> &B, long bOffset,
                                               Concurrency::array_view<double, 1> &C, long cOffset,
                                               int M, int N, int K, int lda, int ldb, int ldc,
                                               double alpha, double beta)
...
static void gemm_NoTransA_loopunroll(Concurrency::array_view<double, 1> &A, long aOffset,
                                     Concurrency::array_view<double, 1> &B, long bOffset,
                                     Concurrency::array_view<double, 1> &C, long cOffset,
                                     int M, int N, int K, int lda, int ldb, int ldc,
                                     double alpha, double beta)
...
static void gemm_NoTransB_loopunroll(Concurrency::array_view<double, 1> &A, long aOffset,
                                     Concurrency::array_view<double, 1> &B, long bOffset,
                                     Concurrency::array_view<double, 1> &C, long cOffset,
                                     int M, int N, int K, int lda, int ldb, int ldc,
                                     double alpha, double beta,
...
static void gemm_TransAB_loopunroll(Concurrency::array_view<double, 1> &A, long aOffset,
                                    Concurrency::array_view<double, 1> &B, long bOffset,
                                    Concurrency::array_view<double, 1> &C, long cOffset,
                                    int M, int N, int K, int lda, int ldb, int ldc,
                                    double alpha, double beta)
...
static void gemm_NoTransAB(Concurrency::array_view<double, 1> &A, long aOffset,
                          Concurrency::array_view<double, 1> &B, long bOffset,
                          Concurrency::array_view<double, 1> &C, long cOffset,
                          int M, int N, int K, int lda, int ldb, int ldc,
                          double alpha, double beta)
...
static void gemm_NoTransA(Concurrency::array_view<double, 1> &A, long aOffset,
                          Concurrency::array_view<double, 1> &B, long bOffset,
                          Concurrency::array_view<double, 1> &C, long cOffset,
                          int M, int N, int K, int lda, int ldb, int ldc,
                          double alpha, double beta)
...
static void gemm_NoTransB(Concurrency::array_view<double, 1> &A, long aOffset,
                          Concurrency::array_view<double, 1> &B, long bOffset,
                          Concurrency::array_view<double, 1> &C, long cOffset,
                          int M, int N, int K, int lda, int ldb, int ldc,
                          double alpha, double beta,
...
static void gemm_TransAB(Concurrency::array_view<double, 1> &A, long aOffset,
                         Concurrency::array_view<double, 1> &B, long bOffset,
                         Concurrency::array_view<double, 1> &C, long cOffset,
                         int M, int N, int K, int lda, int ldb, int ldc,
                         double alpha, double beta)
...
#if STEP
static void gemm_NoTransAB_batch(Concurrency::array_view<double, 1> &A, long aOffset,
                                 Concurrency::array_view<double, 1> &B, long bOffset,
                                 Concurrency::array_view<double, 1> &C, long cOffset,
                                 int M, int N, int K, int lda, int ldb, int ldc,
                                 double alpha, double beta)
...
static void gemm_NoTransA_batch(Concurrency::array_view<double, 1> &A, long aOffset,
                                Concurrency::array_view<double, 1> &B, long bOffset,
                                Concurrency::array_view<double, 1> &C, long cOffset,
                                int M, int N, int K, int lda, int ldb, int ldc,
                                double alpha, double beta)
...
static void gemm_NoTransB_batch(Concurrency::array_view<double, 1> &A, long aOffset,
                                Concurrency::array_view<double, 1> &B, long bOffset,
                                Concurrency::array_view<double, 1> &C, long cOffset,
                                int M, int N, int K, int lda, int ldb, int ldc,
                                double alpha, double beta)
...
static void gemm_TransAB_batch(Concurrency::array_view<double, 1> &A, long aOffset,
                               Concurrency::array_view<double, 1> &B, long bOffset,
                               Concurrency::array_view<double, 1> &C, long cOffset,
                               int M, int N, int K, int lda, int ldb, int ldc,
                               double alpha, double beta)
...
#if STEP_NOBANKCONF
static void gemm_NoTransAB_batch_nobankconf(Concurrency::array_view<double, 1> &A, long aOffset,
                                            Concurrency::array_view<double, 1> &B, long bOffset,
                                            Concurrency::array_view<double, 1> &C, long cOffset,
                                            int M, int N, int K, int lda, int ldb, int ldc,
                                            double alpha, double beta)
...
static void gemm_NoTransA_batch_nobankconf(Concurrency::array_view<double, 1> &A, long aOffset,
                                           Concurrency::array_view<double, 1> &B, long bOffset,
                                           Concurrency::array_view<double, 1> &C, long cOffset,
                                           int M, int N, int K, int lda, int ldb, int ldc,
                                           double alpha, double beta)
...
static void gemm_NoTransB_batch_nobankconf(Concurrency::array_view<double, 1> &A, long aOffset,
                                           Concurrency::array_view<double, 1> &B, long bOffset,
                                           Concurrency::array_view<double, 1> &C, long cOffset,
                                           int M, int N, int K, int lda, int ldb, int ldc,
                                           double alpha, double beta)
...
static void gemm_TransAB_batch_nobankconf(Concurrency::array_view<double, 1> &A, long aOffset,
                                          Concurrency::array_view<double, 1> &B, long bOffset,
                                          Concurrency::array_view<double, 1> &C, long cOffset,
                                          int M, int N, int K, int lda, int ldb, int ldc,
                                          double alpha, double beta)
...
#if SUBMICROTILE
#if NOTRANSAB
static void gemm_NoTransAB_subMicroTile(Concurrency::array_view<double, 1> &A, long aOffset,
                                        Concurrency::array_view<double, 1> &B, long bOffset,
                                        Concurrency::array_view<double, 1> &C, long cOffset,
                                        int M, int N, int K, int lda, int ldb, int ldc,
                                        double alpha, double beta)
...
#if NOTRANSA
static void gemm_NoTransA_subMicroTile(Concurrency::array_view<double, 1> &A, long aOffset,
                                       Concurrency::array_view<double, 1> &B, long bOffset,
                                       Concurrency::array_view<double, 1> &C, long cOffset,
                                       int M, int N, int K, int lda, int ldb, int ldc,
                                       double alpha, double beta)
...
#if NOTRANSB
static void gemm_NoTransB_subMicroTile(Concurrency::array_view<double, 1> &A, long aOffset,
                                       Concurrency::array_view<double, 1> &B, long bOffset,
                                       Concurrency::array_view<double, 1> &C, long cOffset,
                                       int M, int N, int K, int lda, int ldb, int ldc,
                                       double alpha, double beta)
...
#if TRANSAB
static void gemm_TransAB_subMicroTile(Concurrency::array_view<double, 1> &A, long aOffset,
                                      Concurrency::array_view<double, 1> &B, long bOffset,
                                      Concurrency::array_view<double, 1> &C, long cOffset,
                                      int M, int N, int K, int lda, int ldb, int ldc,
                                      double alpha, double beta)
...
#if SUBMICROTILE_NOBANKCONF
#if NOTRANSAB
static void gemm_NoTransAB_subMicroTile_nobankconf(Concurrency::array_view<double, 1> &A, long aOffset,
                                                   Concurrency::array_view<double, 1> &B, long bOffset,
                                                   Concurrency::array_view<double, 1> &C, long cOffset,
                                                   int M, int N, int K, int lda, int ldb, int ldc,
                                                   double alpha, double beta)
...
#endif
#if NOTRANSA
static void gemm_NoTransA_subMicroTile_nobankconf(Concurrency::array_view<double, 1> &A, long aOffset,
                                                  Concurrency::array_view<double, 1> &B, long bOffset,
                                                  Concurrency::array_view<double, 1> &C, long cOffset,
                                                  int M, int N, int K, int lda, int ldb, int ldc,
                                                  double alpha, double beta)
...
#if NOTRANSB
static void gemm_NoTransB_subMicroTile_nobankconf(Concurrency::array_view<double, 1> &A, long aOffset,
                                                  Concurrency::array_view<double, 1> &B, long bOffset,
                                                  Concurrency::array_view<double, 1> &C, long cOffset,
                                                  int M, int N, int K, int lda, int ldb, int ldc,
                                                  double alpha, double beta)
...
#if TRANSAB
static void gemm_TransAB_subMicroTile_nobankconf(Concurrency::array_view<double, 1> &A, long aOffset,
                                                 Concurrency::array_view<double, 1> &B, long bOffset,
                                                 Concurrency::array_view<double, 1> &C, long cOffset,
                                                 int M, int N, int K, int lda, int ldb, int ldc,
                                                 double alpha, double beta)
